...
const ProfileAhli = () => {
  ...
  const [confirmation_new_password, setConfirmation_new_password] =
    useState("");
                        ...
                        return (
                          <UsersComments
                            ...
                            konten={
                              <div
                                dangerouslySetInnerHTML={{
                                  __html: comment.post.description,
                                }}
                                style={{
                                  maxWidth: "100%",
                                  overflowX: "hidden",
                            ...
                            topik={
                              topics.find(
                                (topic) => topic.id === comment.post.topic_id
                              )?.name || "Unknown"
                            }
      ...
      <Modal show={show} onHide={handleClose} size="lg">
        ...
        <Modal.Body>
          <div className="d-flex justify-content-between mx-sm-5 mb-4 active fw-semibold custom-text-a">
            <div
              className={`tab d-flex text-decoration-none fs-md-5 align-items-center custom-text-a ${
                activeTabModal === "edit-data" ? "active" : ""
              }`}
            ...
            <div
              className={`tab d-flex text-decoration-none fs-md-5 align-items-center custom-text-a ${
                activeTabModal === "edit-password" ? "active" : ""
              }`}
            ...
            <div
              className={`tab d-flex text-decoration-none fs-md-5 align-items-center custom-text-a ${
                activeTabModal === "edit-photo" ? "active" : ""
              }`}
              ...
              <Form>
                ...
                <Form.Group className="mb-3" controlId="formConfirmPassword">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setConfirmation_new_password(e.target.value)
                    }
                  />
                </Form.Group>
              </Form>
