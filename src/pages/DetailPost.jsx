...
const DetailPost = () => {
  ...
  const selectedCommentUserId = selectedComment
                  ...
                  <PostCard
                    avatar={
                      detailPost.user && detailPost.user.profile
                        ...
                        : `${API_URL}${detailPost.avatar.avatar_url}`
                    }
                    nama={
                      detailPost.user
                        ? detailPost.user.name
                        : detailPost.avatar.avatar_name
                    }
                  ...
                  {Array.isArray(comments) ? (
                    comments.map((comment, index) => (
                      ...
                      >
                        <Comment
                          ...
                          avatar={
                            comment.user.profile
                              ? `${API_URL}/image/profiles/${comment.user.profile}`
                              : `${API_URL}/image/no-profile.png`
                          }
                        ...
                        />
                        {selectedComment &&
                          loggedInUserId === selectedCommentUserId &&
